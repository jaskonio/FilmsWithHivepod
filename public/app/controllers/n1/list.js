angular.module('myApp').controller('ListN1Controller', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'N1Service', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, N1Service) {
	...
	$scope.add = function () {
		$location.path('/n1/add');
	};

	$scope.edit = function (obj) {
		$location.path('/n1/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/n1/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/n1/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(N1Service, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(N1Service, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('n1').then(function(httpData) {
