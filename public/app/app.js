...
angular.module('myApp', ['ngRoute', 'ngCookies', 'ui.bootstrap', 'ui.bootstrap.datetimepicker',
	...
	.config(['$routeProvider', function ($routeProvider) {
		$routeProvider
			...
			.when('/n1/',			 { templateUrl: 'views/n1/list.html',   controller: 'ListN1Controller' })
			.when('/n1/select',	 { templateUrl: 'views/n1/select.html', controller: 'SelectN1Controller' })
			.when('/n1/add',        { templateUrl: 'views/n1/edit.html',   controller: 'EditN1Controller' })
			.when('/n1/edit/:id', 	 { templateUrl: 'views/n1/edit.html',   controller: 'EditN1Controller' })
			.when('/n1/delete/:id', { templateUrl: 'views/n1/edit.html', 	 controller: 'EditN1Controller' })
			.when('/n1/view/:id', 	 { templateUrl: 'views/n1/edit.html', 	 controller: 'EditN1Controller' })
