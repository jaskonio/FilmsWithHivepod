...
var UserSchema = new mongoose.Schema({
	...
	visitedPlaces: { type: ObjectId, required: true, ref: 'place' } /* Reference */
});
...
var PlaceSchema = new mongoose.Schema({
	...
	user: { type: ObjectId, required: true, ref: 'user' } /* Reference */
});
...
var N1Schema = new mongoose.Schema({
 	_ownerId: { type: String, required: false, index: true },			//userId to enforce security policies
  	_createdAt: { type: Date, required: false, default: Date.now },		//object creation date
	score_phrase: { type: String, required: true },
	title: { type: String, required: true },
	url: { type: String, required: true },
	platform: { type: String, required: true },
	score: { type: String, required: true },
	genre: { type: String, required: false },
	editors_choice: { type: String, required: true },
	release_year: { type: String, required: true },
	release_month: { type: String, required: true },
...
var propertiesForClass = {
	...
	"n1" : ['score_phrase', 'title', 'url', 'platform', 'score', 'genre', 'editors_choice', 'release_year', 'release_month', 'release_day']  
};
...
buildModelAndControllerForSchema(models, 'n1', 'n1', N1Schema);
